...
import 'package:ehsan_chat/src/ui/personal_chat/widgets/message_field_bottom_sheet.dart';
...
class _PersonalChatState extends State<PersonalChat> with AutomaticKeepAliveClientMixin{
  late Private conv;
    ...
    return Scaffold(
      body: SizedBox(
        ...
        child: Column(
          children: [
            _getAppbar(context),
            AudioBarController(key: UniqueKey(),),
            _getChatContent(),
            ...
            children: [
              ...
              Consumer<ChatProvider>(
                builder: (context, chatProvider, child) => Text(
                  chatProvider.connectionState.state,
                  style: TextStyle(
                    fontSize: 12,
